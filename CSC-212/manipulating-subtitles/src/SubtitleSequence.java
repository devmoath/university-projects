...
public class SubtitleSequence {
    ...
    public void addSubtitle(Subtitle st) {
        if (subtitles.empty()) subtitles.insert(st); else {
            subtitles.findFirst();
    ...
    public Subtitle getSubtitle(Time time) {
        if (subtitles.empty()) return null; else return search(time);
    }
    ...
    private Subtitle search(Time time) {
        ...
        while (!subtitles.last()) {
            if (
                ((Time) time).toMiliSec() == ((Time) subtitles.retrieve().getStartTime()).toMiliSec()
    ...
    private int search1(Time time) {
        ...
        subtitles.findFirst();
        while (!subtitles.last()) {
            if (((Time) time).toMiliSec() == ((Time) subtitles.retrieve().getStartTime()).toMiliSec()) return counter;
            subtitles.findNext();
            counter++;
        }
        if (((Time) time).toMiliSec() == ((Time) subtitles.retrieve().getStartTime()).toMiliSec()) return ++counter;
    ...
    public List<Subtitle> getSubtitles(Time startTime, Time endTime) {
        if (subtitles.empty()) return null;
        LinkedList<Subtitle> k = new LinkedList<Subtitle>();
        subtitles.findFirst();
        while (!subtitles.last()) {
            if (
                ((Time) startTime).toMiliSec() <= ((Time) subtitles.retrieve().getStartTime()).toMiliSec() &&
                ((Time) endTime).toMiliSec() >= ((Time) subtitles.retrieve().getEndTime()).toMiliSec()
    ...
    public List<Subtitle> getSubtitles(String str) {
        ...
        subtitles.findFirst();
        while (!subtitles.last()) {
            if (subtitles.retrieve().getText().contains(str)) k.insert(subtitles.retrieve());
            subtitles.findNext();
        }
        if (subtitles.retrieve().getText().contains(str)) k.insert(subtitles.retrieve());
        return k;
    ...
    public void remove(String str) {
        ...
        subtitles.findFirst();
        while (!subtitles.last()) {
            if (subtitles.retrieve().getText().contains(str)) subtitles.remove();
            subtitles.findNext();
        }
        if (subtitles.retrieve().getText().contains(str)) subtitles.remove();
    }
    ...
    public void replace(String str1, String str2) {
        ...
        subtitles.findFirst();
        while (!subtitles.last()) {
            if (subtitles.retrieve().getText().equals(str1)) subtitles.retrieve().setText(str2);
            subtitles.findNext();
        }
        if (subtitles.retrieve().getText().equals(str1)) subtitles.retrieve().setText(str2);
    }
    ...
    public void shift(int offset) {
        ...
        while (!subtitles.last()) {
            ...
            if (((Time) subtitles.retrieve().getEndTime()).toMiliSec() == 0) subtitles.remove();
            subtitles.findNext();
        }
        ((Time) subtitles.retrieve().getStartTime()).increaseTime(offset);
        ((Time) subtitles.retrieve().getEndTime()).increaseTime(offset);
    ...
    public void cut(Time startTime, Time endTime) {
        ...
        while (!subtitles.last()) {
            if (
                (
                    ((Time) startTime).toMiliSec() <= ((Time) subtitles.retrieve().getStartTime()).toMiliSec() ||
                    ((Time) startTime).toMiliSec() <= ((Time) subtitles.retrieve().getEndTime()).toMiliSec()
                ) &&
                (
                    ((Time) endTime).toMiliSec() >= ((Time) subtitles.retrieve().getEndTime()).toMiliSec() ||
                    ((Time) endTime).toMiliSec() >= ((Time) subtitles.retrieve().getStartTime()).toMiliSec()
                )
            ) subtitles.remove();
            subtitles.findNext();
        }
    ...
    public void display() {
        ...
        if (!subtitles.empty()) ((Subtitle) subtitles.retrieve()).display();
    }
}
