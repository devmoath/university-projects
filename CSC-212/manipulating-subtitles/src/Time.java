public class Time {
    ...
    public void display() {
        if (hour <= 9) System.out.print("0");
        System.out.print(hour + ":");
        if (minute <= 9) System.out.print("0");
        System.out.print(minute + ":");
        if (second <= 9) System.out.print("0");
        System.out.print(second + ",");
        if (milliSecond <= 99) System.out.print("0");
        if (milliSecond <= 9) System.out.print("0");
